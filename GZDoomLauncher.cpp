...
public:
	                          ...
	                          startPath, true, true)
	{
		...
		BStringView *urlDescDoomHexenString = new BStringView(O_DATA_LINK_DESC, L_DATA_HEXEN_TEXT);
		BStringView *urlDescDoomHereticString = new BStringView(O_DATA_LINK_DESC, L_DATA_HERETIC_TEXT);
		...
		BGroupLayout *boxLayout = BLayoutBuilder::Group<>(B_VERTICAL, B_USE_HALF_ITEM_SPACING)
									...
									.AddGroup(B_HORIZONTAL, 0.0f)
										.Add(new BStringView(O_DOT, L_DOT))
										.Add(urlDescDoomHexenString)
										.Add(urlStringHexen)
										.AddGlue()
									.End()
									.AddGroup(B_HORIZONTAL, 0.0f)
										.Add(new BStringView(O_DOT, L_DOT))
										.Add(urlDescDoomHereticString)
